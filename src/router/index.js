    ...
    children: [
      {
        path: '/daftar-gate',
        alias: '/',
        component: () => import('@/views/components/DaftarGate'),
        name: 'Daftar Gate',
        meta: {
          title: 'route.daftarGate', icon: 'mdi-view-dashboard', noCache: true, affix: true,
        },
      },
    ],
  },
    ...
    children: [
      {
        ...
        alias: '/',
        component: () => import('@/views/components/DaftarPengunjung'),
        name: 'Daftar Pengunjung',
        meta: {
          title: 'route.daftarPengunjung', icon: 'mdi-view-dashboard', noCache: true, affix: true,
        },
      },
    ],
  },
    ...
    children: [
      {
        path: '/daftar-tempat',
        alias: '/',
        component: () => import('@/views/components/DaftarTempat'),
        name: 'Daftar Tempat',
        meta: {
          title: 'route.daftarTempat', icon: 'mdi-view-dashboard', noCache: true, affix: true,
        },
      },
    ],
  },
    ...
    children: [
      {
        ...
        name: 'Form',
        meta: {
          title: 'route.form', icon: 'mdi-view-dashboard', noCache: true, affix: true,
        },
      },
    ],
  },
